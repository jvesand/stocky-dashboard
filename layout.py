...
class Layout:
    ...
    def layout(self):
        return dbc.Container(  # Container centers
            [
                # check cheat sheet , mt is margin
                dbc.Card(
                ...
                dbc.Row(
                    ...
                    children=[
                        dbc.Col(
                            ...
                            lg=4,
                            xl={"offset": 2, "size": 2},
                        ),  # can use dictionary to give more granula arguments
                        dbc.Col(
                            dcc.Dropdown(
                            ...
                            sm=12,
                            md=12,
                            lg=4,  # specifying width (total width is 12) (for large screens)
                            xl=3,
                        ),
                        dbc.Col(
                            dbc.Card(
                                ...
                                dbc.Row(
                                    dbc.Card(
                                        [
                                            ...
                                            ),  # h5 smaller size, in bootstrap can have several style classes
                                            html.P(
                                                id="highest-value",
